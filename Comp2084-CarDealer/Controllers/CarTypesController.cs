...
namespace Comp2084_CarDealer.Controllers
{
    public class CarTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,Name,NumberOfSeats")] CarType carType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Name,NumberOfSeats")] CarType carType)
        {
            if (ModelState.IsValid)
            {
